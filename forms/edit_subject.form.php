					...
					<form action="index.php?edit=subject&edit_id=<?php echo $row['id'] ?>" method="POST">
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control" type="text" id="subject_code" name="subject_code" value="<?php echo $row['subject_code'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label for="subject_name">Subject Name</label>
								<input class="form-control" type="text" id="subject_name" name="subject_name" value="<?php echo $row['subject_name'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label for="subject_desc">Subject Description</label>
								<input class="form-control" type="text" name="subject_desc" value="<?php echo $row['subject_desc'] ?>">
							</div>
							<div class="form-group col-md-6">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control" type="text" id="lec_unit" name="lec_unit" value="<?php echo $row['lec_unit'] ?>">
							</div>
							<div class="form-group col-md-6">
								<label for="lab_unit">Lab Unit</label>
								<input class="form-control" type="text" id="lab_unit" name="lab_unit" value="<?php echo $row['lab_unit'] ?>">
							</div>
						</div>
