		 	 		 	...
		 	 		 	if ($student_count > 0) {
		 	 		 		...
		 	 		 		while ($row = mysqli_fetch_assoc($select_student)) {
		 	 		 			...
		 	 		 			if ($x) {
			 	 		 			...
			 	 		 			$insert_account_st = query("insert into account_list (account_type, student_id, name, username, password) 
														 		values ('$account_type', '$student_id', '$student_name', '$usn', '$password')");
