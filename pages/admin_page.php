...
if(isset($_GET['menu'])) {
	switch ($_GET['menu']) {
		...
		case 'trimester_list':
				require_once 'trimester_list.php';
				break;
		...
		case 'curriculum_list':
				require_once 'curriculum_list.php';
				break;
		...
		case 'degree_list':
				require_once 'degree_list.php';
				break;

		case 'petition_list':
				require_once 'request_to_open_list.php';
				break;

		case 'account_list':
				require_once 'account_list.php';
				break;
