				...
				if($student_list):
					while($row = mysqli_fetch_assoc($student_list)):
						...
						<tr>
							...
							<td>
								<a href="index.php?view=student_subject&view_id=<?php echo $row['id'] ?>" title="View Student Subject"><i class="fas fa-eye"></i></a>
								<a href="index.php?edit=student&edit_id=<?php echo $row['id'] ?>" title="Edit"><i class="fas fa-edit"></i></a>
								<a href="index.php?delete=student&delete_id=<?php echo $row['id'] ?>" title="Delete"><i class="fas fa-trash"></i></a>
							</td>
						</tr>
						<?php
					endwhile;
